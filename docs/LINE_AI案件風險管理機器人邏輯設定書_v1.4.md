...
| 情境 | 行為 |
|---|---|
| 上班時間收到一般訊息 | 超過 4 小時未回覆，提醒。 |
| 下班後收到一般訊息 | 隔天 09:30 檢查。 |
| critical 關鍵字 | 不等 4 小時，立即提醒。 |
| 圖片或語音但無文字 | 10 分鐘內等待前後文；仍無文字則建立「圖片待確認」。 |
